...
<head>
    ...
    <title>Download - Customer Orders Tracker</title>
...
<div class="navbar">
    ...
    <div class="container">
        <div class="header">
            <h1>Download Customer Orders Tracker</h1>
            <p>Thank you for signing up! You can now download the app.</p>
            <a href="download-link.zip" class="btn">Download Now</a>
        </div>
    </div>
